...
plt.xlabel('Epoch')
plt.ylabel('MSE')
plt.title('MSE over Epochs - Validation Data Anneal')
plt.legend()
plt.show()
...
#need a graph of learning parameter against mse to see which has the minimum mse
...
plt.title('Predicted vs Actual - Test Data Anneal')
plt.legend()
plt.show()
