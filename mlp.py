...
plt.xlabel('Epoch')
plt.ylabel('MSE')
plt.title('MSE over Epochs - Validation Data MLP with momentum')
plt.legend()
plt.show()
...
for i in range(len(df_test)):
    ...
    modelled_test.append(index_flood_predicted.item())
...
plt.title('Predicted vs Actual - Test Data MLP with momentum')
plt.legend()
plt.show()
